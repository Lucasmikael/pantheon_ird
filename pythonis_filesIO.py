...
def resMod(r_a, r_b, r_start, r_flow, r_stable, r_gene_list, r_network_structure, nb_genes, KO_genes, OA_genes, model_type, boundary_model, network_values, nb_initial_states,
            nb_stable_states, data, output_file = 'Run_output'):
    """
