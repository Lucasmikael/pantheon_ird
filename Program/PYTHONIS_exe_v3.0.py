...
if __name__ == "__main__":
    ...
    while True :
        ...
        if check_init_gene_list == True  and check_init_interaction == True and check_format_gene_list == True and check_format_interaction == True:
                ...
                for i in range(7):
                    ...
                    # catch all parameters from the GUI
                        ...
                        if event_visu == 'Add element from CSV':
                            ...
                            if check == True and check_format_load == True :
                        ...
                        if event_visu == "Load" and not active_4 :
                            ...
                            if check == False :
                                sg.popup_error("File doesn't exist in specified folder")
                            if check == True  and check_format_savednetwork == True :
                                active_4 = True
